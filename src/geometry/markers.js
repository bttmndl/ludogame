export function generateDropdownMarker(boxes, pulseToggle) {
    ...
    function generateCords(rectanglePoints) {
      ...
      const headRadius = pulseToggle ? 20.3 : 17.3; // calculating radius based on the width of the rectangle
      const leftShift = pulseToggle ? 55 : 35;
